...
# Streamlit App
st.title("Stock and Cryptocurrency Performance Overview")

# Allow user to sort results interactively
st.write("Sort the table by clicking on the column headers")
st.dataframe(results.sort_values(by='Total Return (%)', ascending=False))
